...
class CapaRestController extends AbstractRestfulController
{
    // Listar - GET
    public function getList()
    {
        $data = $this->getServiceLocator()->get('capa-factory')->findArray();
    ...
    {
        $data = $this->getServiceLocator()->get('capa-factory')->findByIdArray($id);
        return new JsonModel(array('data'=>$data));
    }
    ...
    {
        $userService = $this->getServiceLocator()->get('SONUser\Service\Capa');
