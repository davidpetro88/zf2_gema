...
class RoleRestController extends AbstractRestfulController
{
    ...
    {
        $data = $this->getServiceLocator()->get('role-factory')->findArray();
    ...
    {
        $data = $this->getServiceLocator()->get('role-factory')->findByIdArray($id);
        return new JsonModel(array('data'=>$data));
    }
    ...
    {
        $userService = $this->getServiceLocator()->get('SONUser\Service\Role');
